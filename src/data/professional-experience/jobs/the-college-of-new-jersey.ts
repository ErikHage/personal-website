  ...
  projects: [
    {
      ...
      summary: 'Designed a biomedical/electrical engineering lab project for freshmen students. The students were provided a circuit diagram with missing values and the equations needed to solve for those values. In groups, the students would need to apply those equations to figure out resistances required in their amplifier circuit. They would then need to fabricate it and test it using a signal generator. The goal was to have an LED blink along with the signal peaks',
      skillsUsed: [ 'Circuits', 'Medical Devices', ],
    },
    {
      title: 'Statics Coding Projects',
      // todo remember what second project was.
      summary: 'Put together two coding projects as part of the ENG-222: Statics course work. Students were allowed to use MATLAB or C++ to accomplish these. The first project was to write a program that could find the resultant of three (or more) forces. The second was ???',
